                     ...
                     flatlogs::bufferPtrT & buffer )
{
   ...
   switch(ec)
   {
      ...
      case 1051:
         return flatlogs::stdFormat<ao_operator>(ios, buffer);
      case 11025:
      ...
      case 20923:
         return flatlogs::stdFormat<telem_offloading>(ios, buffer);
      case 20930:
         return flatlogs::stdFormat<telem_pi335>(ios, buffer);
      case 20940:
         return flatlogs::stdFormat<telem_sparkleclock>(ios, buffer);
      case 20945:
         return flatlogs::stdFormat<telem_poltrack>(ios, buffer);
      default:
                          ...
                          flatlogs::bufferPtrT & buffer )
{
   ...
   switch(ec)
   {
      ...
      case 1051:
         return flatlogs::stdShortFormat<ao_operator>(ios, appName, buffer);
      case 11025:
      ...
      case 20923:
         return flatlogs::stdShortFormat<telem_offloading>(ios, appName, buffer);
      case 20930:
         return flatlogs::stdShortFormat<telem_pi335>(ios, appName, buffer);
      case 20940:
         return flatlogs::stdShortFormat<telem_sparkleclock>(ios, appName, buffer);
      case 20945:
         return flatlogs::stdShortFormat<telem_poltrack>(ios, appName, buffer);
      default:
         ios << "Unknown log type: " << ec << "\n";
         return ios;
   }
                        ...
                        flatlogs::bufferPtrT & buffer )
{
   ...
   switch(ec)
   {
      ...
      case 1051:
         return flatlogs::minFormat<ao_operator>(ios, buffer);
      case 11025:
      ...
      case 20923:
         return flatlogs::minFormat<telem_offloading>(ios, buffer);
      case 20930:
         return flatlogs::minFormat<telem_pi335>(ios, buffer);
      case 20940:
         return flatlogs::minFormat<telem_sparkleclock>(ios, buffer);
      case 20945:
         return flatlogs::minFormat<telem_poltrack>(ios, buffer);
      default:
         ios << "Unknown log type: " << ec << "\n";
         return ios;
   }
...
#include "binarySchemata.inc"
   ...
   switch(ec)
   {
      ...
      case 1051:
         return flatlogs::jsonFormat<ao_operator>(ios, buffer, "ao_operator", reinterpret_cast<const uint8_t *>(observer_bfbs), observer_bfbs_len);
      case 11025:
      ...
      case 20923:
         return flatlogs::jsonFormat<telem_offloading>(ios, buffer, "telem_offloading", reinterpret_cast<const uint8_t *>(telem_offloading_bfbs), telem_offloading_bfbs_len);
      case 20930:
      ...
      case 20940:
         return flatlogs::jsonFormat<telem_sparkleclock>(ios, buffer, "telem_sparkleclock", reinterpret_cast<const uint8_t *>(telem_sparkleclock_bfbs), telem_sparkleclock_bfbs_len);
      case 20945:
         return flatlogs::jsonFormat<telem_poltrack>(ios, buffer, "telem_poltrack", reinterpret_cast<const uint8_t *>(telem_poltrack_bfbs), telem_poltrack_bfbs_len);
      default:
         ios << "Unknown log type: " << ec << "\n";
         return ios;
   }
