                       ...
                       flatlogs::msgLenT len )
{
   switch(ec)
   {
      ...
      case 1051:
         return ao_operator::verify(buffer, len);
      case 11025:
      ...
      case 20923:
         return telem_offloading::verify(buffer, len);
      case 20930:
         return telem_pi335::verify(buffer, len);
      case 20940:
         return telem_sparkleclock::verify(buffer, len);
      case 20945:
         return telem_poltrack::verify(buffer, len);
      default:
