...
struct Telem_observer_fb FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::String *tgt_name() const {
    return GetPointer<const ::flatbuffers::String *>(VT_TGT_NAME);
  }
  const ::flatbuffers::String *operator_email() const {
    return GetPointer<const ::flatbuffers::String *>(VT_OPERATOR_EMAIL);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_TGT_NAME) &&
           verifier.VerifyString(tgt_name()) &&
           VerifyOffset(verifier, VT_OPERATOR_EMAIL) &&
           verifier.VerifyString(operator_email()) &&
           verifier.EndTable();
  }
};
...
struct Telem_observer_fbBuilder {
  ...
  void add_tgt_name(::flatbuffers::Offset<::flatbuffers::String> tgt_name) {
    fbb_.AddOffset(Telem_observer_fb::VT_TGT_NAME, tgt_name);
  }
  void add_operator_email(::flatbuffers::Offset<::flatbuffers::String> operator_email) {
    fbb_.AddOffset(Telem_observer_fb::VT_OPERATOR_EMAIL, operator_email);
  }
...
inline ::flatbuffers::Offset<Telem_observer_fb> CreateTelem_observer_fb(
  ...
  builder_.add_operator_email(operator_email);
  builder_.add_tgt_name(tgt_name);
...
inline ::flatbuffers::Offset<Telem_observer_fb> CreateTelem_observer_fbDirect(
  ...
  auto tgt_name__ = tgt_name ? _fbb.CreateString(tgt_name) : 0;
  auto operator_email__ = operator_email ? _fbb.CreateString(operator_email) : 0;
