...
struct Telem_stdcam_fb FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::String *readout_speed() const {
    return GetPointer<const ::flatbuffers::String *>(VT_READOUT_SPEED);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_READOUT_SPEED) &&
           verifier.VerifyString(readout_speed()) &&
           verifier.EndTable();
  }
};
...
struct Telem_stdcam_fbBuilder {
  ...
  void add_readout_speed(::flatbuffers::Offset<::flatbuffers::String> readout_speed) {
    fbb_.AddOffset(Telem_stdcam_fb::VT_READOUT_SPEED, readout_speed);
  }
...
inline ::flatbuffers::Offset<Telem_stdcam_fb> CreateTelem_stdcam_fb(
    ...
    float vshift = 0.0f,
    int8_t cropMode = -1,
    ::flatbuffers::Offset<::flatbuffers::String> readout_speed = 0) {
  Telem_stdcam_fbBuilder builder_(_fbb);
  builder_.add_readout_speed(readout_speed);
...
inline ::flatbuffers::Offset<Telem_stdcam_fb> CreateTelem_stdcam_fbDirect(
    ...
    float vshift = 0.0f,
    int8_t cropMode = -1,
    const char *readout_speed = nullptr) {
  auto mode__ = mode ? _fbb.CreateString(mode) : 0;
  auto readout_speed__ = readout_speed ? _fbb.CreateString(readout_speed) : 0;
