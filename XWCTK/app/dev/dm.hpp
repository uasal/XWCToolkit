/** \file dm.hpp
 * \brief The XWCToolkit generic deformable mirror controller.
 *
...
/** XWCToolkit generic deformable mirror controller
  *
  *
...
protected:
    ...
    /// Thread starter, called by XWCTkApp::threadStart on thread construction.  Calls satThreadExec.
...
{
    config.add("dm.calibPath", "", "dm.calibPath", argType::Required, "dm", "calibPath", false, "string", "The path to calibration files, relative to the XWCToolkit calibration path.");
