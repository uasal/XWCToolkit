 ...
 * \brief The XWCToolkit generic shared memory monitor.
 *
...
/** XWCToolkit generic shared memory monitor
  *
  *
...
protected:
    ...
    /// Thread starter, called by XWCTkApp::threadStart on thread construction.  Calls smThreadExec.
