...
/// XWCToolkit standard motion stage interface
/** Implements the standard interface to a XWCToolkit motion stage.
  ...
  * 
  * The derived class `derivedT` must be a XWCTkApp\<true\>, and should declare this class a friend like so: 
   \code
