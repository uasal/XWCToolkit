/** \file frameGrabber.hpp
  * \brief The XWCToolkit generic frame grabber.
  *
...
/** XWCToolkit generic frame grabber
  *
  * 
...
protected:
   ...
   ///Thread starter, called by XWCTkApp::threadStart on thread construction.  Calls fgThreadExec.
