...
/// XWCToolkit standard camera interface
/** Implements the standard interface to a XWCToolkit camera.  The derived class `derivedT` must
  * meet the following requirements:
  * 
  * - The derived class `derivedT` must be a `XWCTkApp\<true\>`
  *  
