/** \file semUtils.hpp
  * \brief XWCTK app semaphore Utilities
...
/** An error would be generated by clock_gettime.
  ...
  *  
  */
#define XWCTK_SEM_WAIT_TS_RETVOID( ts, sec, nsec )                             \
...
/** An error would be generated by clock_gettime
  ...
  *  
  */
#define XWCTK_SEM_WAIT_TS( ts, sec, nsec )                                     \
    if(clock_gettime(CLOCK_REALTIME, &ts) < 0)                               \
    {                                                                        \
        log<software_critical>({__FILE__,__LINE__,errno,0,"clock_gettime"}); \
        return -1;                                                           \
...
/**
  ...
  *  
  */
#define XWCTK_SEM_TIMEDWAIT_LOOP( sem, ts )                                                    \
