...
/** Is a wrapper for XWCTkApp::registerIndiPropertyNew.
  *
...
/** Is a wrapper for XWCTkApp::registerIndiPropertyNew with  NULL callback.
  *
  * \param prop the property member name, with no quotes
  * \param propName the property name, in quotes
  * \param type the property type, pcf::IndiProperty::Type
...
/** Is a wrapper for XWCTkApp::registerIndiPropertySet.
  *
  * \param prop the property member name, with no quotes
  * \param propName the property name, in quotes
  * \param type the property type, pcf::IndiProperty::Type
...
/** This wraps createStandardIndiNumber and registerIndiPropertyNew, with error checking.
  ...
  * \param format [in] the _ value for the elements, applied to both target and current.  Set to "" to use the XWCToolkit standard for type.
