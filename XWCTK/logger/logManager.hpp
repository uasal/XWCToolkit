/** \file logManager.hpp
  * \brief The XWCToolkit log manager.
...
/// The standard XWCTk log manager, used for both process logs and telemetry streams.
...
protected:
   ...
   unsigned long m_writePause {XWCTK_default_writePause}; ///< Time, in nanoseconds, to pause between successive batch writes to the file. Default is 1e9. Configure with logger.writePause.
